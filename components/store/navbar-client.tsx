      ...
      <nav className="flex items-center gap-2 sm:gap-4 px-2 sm:px-4 bg-[#131921] h-[60px] text-white">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div
              className={`${navBoxClass} flex-row items-end gap-1 min-w-[120px]`}
            >
        ...
        <Link
          href="/cart"
          className="flex items-end px-2 py-1 border border-transparent rounded-sm relative cursor-pointer h-[44px]"
        >
